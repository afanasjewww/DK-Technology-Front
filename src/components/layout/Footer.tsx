...
export async function Footer() {
  ...
  return (
    <footer className="bg-dk-gray-950 text-dk-gray-300">
      <Container>
              ...
              <ul className="space-y-2">
                {navLinks.map((link) => (
                  <li key={link.href}>
                    <Link
                      href={link.href}
                      className="text-sm text-dk-gray-400 hover:text-dk-red-400 transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
              ...
              <ul className="space-y-3">
                <li>
                  <a
                    ...
                    className="text-sm text-dk-gray-400 hover:text-dk-red-400 transition-colors flex items-center gap-2"
                  >
                ...
                <li className="text-sm text-dk-gray-400 flex items-center gap-2">
                  <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg>
        ...
        {/* Bottom bar */}
        <div className="border-t border-dk-gray-800 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-dk-gray-500">
            {t('copyright', { year: new Date().getFullYear() })}
          </p>
          <div className="flex items-center gap-6">
            <Link href="/" className="text-xs text-dk-gray-500 hover:text-dk-gray-300 transition-colors">
              {t('privacy')}
            </Link>
            <Link href="/" className="text-xs text-dk-gray-500 hover:text-dk-gray-300 transition-colors">
              {t('terms')}
